      ...
      if (1) begin : \/fpga_pins 
         ...
         if (1) begin : \/fpga 
            ...
            if (1) begin : P_calc
               ...
               (* keep *) logic [7:0] \///?$valid_or_reset@2$out ;
               assign \///?$valid_or_reset@2$out = FpgaPins_Fpga_CALC_out_a2;
...
//_\TLV
   ...
   //_\source /raw.githubusercontent.com/osfpga/VirtualFPGALab/35e36bd144fddd75495d4cbc01c4fc50ac5bde6f/tlvlib/tinytapeoutlib.tlv 76   // Instantiated from top.tlv, 199 as: m5+tt_connections()
   ...
   //_\source /raw.githubusercontent.com/osfpga/VirtualFPGALab/a069f1e4e19adc829b53237b3e0b5d6763dc3194/tlvlib/fpgaincludes.tlv 307   // Instantiated from top.tlv, 202 as: m5+board(/top, /fpga, 7, $, , calc)
            ...
            //_\source top.tlv 49   // Instantiated from /raw.githubusercontent.com/osfpga/VirtualFPGALab/a069f1e4e19adc829b53237b3e0b5d6763dc3194/tlvlib/fpgaincludes.tlv, 340 as: m4+calc.
               ...
               //_|calc
                  ...
                  //_@1
                     ...
                     //$valid[1:0] = >>1$valid ? 1'b0 : (>>1$valid[1:0] + 1);
                     //$valid[1:0] = $reset ? 1'b0 : $equals_in == 1;
                  ...
                  //_?$valid_or_reset
                     ...
                     //_@2
                        ...
                        assign FpgaPins_Fpga_CALC_out_a2[7:0] =
                           FpgaPins_Fpga_CALC_reset_a2
                              ? 8'b0 :
                           FpgaPins_Fpga_CALC_valid_a2 == 1'b0
               ...
               //_\source /raw.githubusercontent.com/efabless/chipcraftmestcourse/main/tlvlib/calculatorshelllib.tlv 4   // Instantiated from top.tlv, 139 as: m5+cal_viz(@2, /fpga)
                  // Only for Makerchip.
   ...
   //_\source /raw.githubusercontent.com/osfpga/VirtualFPGALab/35e36bd144fddd75495d4cbc01c4fc50ac5bde6f/tlvlib/tinytapeoutlib.tlv 82   // Instantiated from top.tlv, 204 as: m5+tt_input_labels_viz(⌈"Value[0]", "Value[1]", "Value[2]", "Value[3]", "Op[0]", "Op[1]", "Op[2]", "="⌉)
